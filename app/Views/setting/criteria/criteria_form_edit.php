                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-15 f-s-12">Used to edit classification score.</p>
                                <div class="form-validation">
                                    <form class="form-valide" action="/setting/criteria/update" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-criteria">classification Score <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="hidden" class="form-control" id="val-id" name="val-id" value="<?= $criteria['id']?>">
                                                <input type="number" class="form-control" id="val-criteria" max=100 min=0 name="val-criteria" value="<?= $criteria['criteria']?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-notes" name="val-notes" placeholder="Enter text of classification.." value="<?= $criteria['notes']?>">
                                            </div>
                                        </div>
